...
class MyPIMTestCase2(unittest.TestCase):
    ...
    def test_PIMAddTC1(self):
        ...
        time.sleep(5)
        #edit person
        self.driver.find_element(By.XPATH, "//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[1]/div/div[9]/div/button[2]").click()
